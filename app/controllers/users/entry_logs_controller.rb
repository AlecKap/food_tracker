class Users::EntryLogsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @entry_log.save
        format.html { redirect_to user_entry_logs_path(current_user), notice: "Entry log was successfully created." }
  ...
  def update
    respond_to do |format|
      if @entry_log.update(entry_log_params)
        format.html { redirect_to user_entry_logs_path(current_user), notice: "Entry log was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_entry_logs_path(current_user), status: :see_other, notice: "Entry log was successfully destroyed." }
